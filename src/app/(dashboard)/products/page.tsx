  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-2 text-sm text-neutral-600">Browse our available products and services</p>
      </div>
        ...
        {products.map((product) => {
          ...
          return (
            <Link
              ...
              className="group relative rounded-lg border border-neutral-200 bg-white p-6 shadow-sm transition-all hover:shadow-md hover:border-primary-300"
            >
              <div className="flex flex-col h-full">
                ...
                <div className="mt-4 flex items-baseline justify-between">
                  ...
                  <span className="text-sm text-neutral-500">{product.duration} min</span>
                </div>

                {hasDiscount && (
                  <div className="mt-2 inline-flex items-center rounded-full bg-success-light px-2.5 py-0.5 text-xs font-medium text-success-dark">
      ...
      {products.length === 0 && (
        <div className="rounded-lg border-2 border-dashed border-neutral-300 p-12 text-center">
          <p className="text-sm text-neutral-600">No products available at the moment.</p>
        </div>
      )}
    </div>
  );
