                ...
                <tr key={org.id} className="hover:bg-neutral-50">
                  <td className="px-6 py-4">
                    <div className="flex flex-col">
                      ...
                      {org.email && (
                        <div className="mt-1 text-sm text-neutral-500">{org.email}</div>
                      )}
                    </div>
                  </td>
                  <td className="px-6 py-4">
                    ...
                    <div className="text-xs text-neutral-500">{org.owner.email}</div>
                  </td>
                  <td className="px-6 py-4">
                    <div className="text-sm text-neutral-900">
                  ...
                  <td className="px-6 py-4 text-sm text-neutral-900">{org.discountPercent}%</td>
                  <td className="px-6 py-4 text-sm text-neutral-900">{org._count.packages}</td>
                  <td className="px-6 py-4">
                    <button
