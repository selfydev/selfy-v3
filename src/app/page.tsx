      ...
      <div className="relative isolate overflow-hidden">
        ...
        <div className="mx-auto max-w-7xl px-6 py-24 sm:py-32 lg:px-8">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-6 text-lg leading-8 text-neutral-600">
              Sprint 3: Authentication with NextAuth, user management with Prisma, and protected
              routes. Sign up to get started!
            </p>
            <div className="mt-10 flex items-center justify-center gap-x-6">
              ...
              <Link
                href="/auth/signin"
                className="rounded-md border border-neutral-300 bg-white px-3.5 py-2.5 text-sm font-semibold text-neutral-900 shadow-sm hover:bg-neutral-50"
              >
                Sign In
              </Link>
        ...
        <div id="features" className="mx-auto max-w-7xl px-6 py-24 sm:py-32 lg:px-8">
          <div className="mx-auto max-w-2xl lg:text-center">
            <h2 className="text-base font-semibold leading-7 text-primary-600">Sprint 3</h2>
